...
public class editScreen extends JFrame {
   ...
   public static void start(String id, String name) {
      EventQueue.invokeLater(new Runnable() {
         public void run() {
            try {
               editScreen window = new editScreen(id, name);
    ...
    */
   public editScreen(String id, String name) {
	   this.id = id;
	   this.getName = name;
      initialize();
   }
   ...
   private void initialize() {
	  ...
	  JLabel lblNewLabel_8 = new JLabel("정보 수정");
	  lblNewLabel_8.setFont(new Font("함초롬돋움", Font.BOLD, 25));
	  ...
	  lblNewLabel_4.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	  lblNewLabel_4.setHorizontalAlignment(SwingConstants.CENTER);
	  panel_5.add(lblNewLabel_4);
	  
	  tel = new JTextField(arr[2]);
	  ...
	  lblNewLabel_3.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	  lblNewLabel_3.setHorizontalAlignment(SwingConstants.CENTER);
	  panel_7.add(lblNewLabel_3);
	  
	  JButton btnNewButton_2 = new JButton("사진 등록");
	  Image img2  = new ImageIcon(editScreen.class.getResource("/image/Pic.png")).getImage();
	  ...
	  m_imgButton.addActionListener(new ActionListener() {
	    ...
	    jFileChooser.addChoosableFileFilter(new FileNameExtensionFilter(
	          "텍스트 파일(*.txt)", "txt"));
	    int option = jFileChooser.showOpenDialog(editScreen.this);
	    // 어떤 버튼을 클릭했는지 확인하기
	  ...
	  Image img3  = new ImageIcon(editScreen.class.getResource("/image/Pic.png")).getImage();
	  ...
	  lblNewLabel_7_1.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	  lblNewLabel_7_1.setHorizontalAlignment(SwingConstants.CENTER);
	  panel_9.add(lblNewLabel_7_1);
	  
	  url = new JTextField(arr[3]);
	  ...
	  lblNewLabel_5.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	  panel_6.add(lblNewLabel_5);
	  
	  price = new JTextField(arr[9]);
	  panel_6.add(price);
	  price.setColumns(10);
	  ...
	  kor.setFont(new Font("함초롬돋움", Font.PLAIN, 16));
	  panel_11.setFont(new Font("함초롬돋움", Font.PLAIN, 15));
	 ...
	 lblNewLabel_9.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	 ...
	 btnNewButton.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	 Image img  = new ImageIcon(editScreen.class.getResource("/image/ok.png")).getImage();
...
//	     String Cmt = "";
	     ...
	     if(Star >= 0 && Star <= 5) {
	    	 try {
				new editDb(Name, Addr, Tel, Url, Price, Menu, Subj, Star);
			} catch (Exception e1) {
	 ...
	 btnNewButton_1.setFont(new Font("함초롬돋움", Font.PLAIN, 20));
	 Image img1  = new ImageIcon(editScreen.class.getResource("/image/backback.png")).getImage();
   ...
   public void getInput(String id, String name) {
	   arr = new GetDb(id, name).getInfo();
   }
}